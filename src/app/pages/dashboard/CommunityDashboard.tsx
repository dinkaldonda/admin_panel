        ...
        <div id='' className='app-container container-xxl d-flex flex-stack pt-0 mt-0'>
          ...
          <div className='d-flex align-items-center gap-2 gap-lg-3'>
            <ul className='nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-n2'>
              ...
              >
                <a className='nav-link cursor-pointer text-active-primary pb-4 '>Buildings</a>
              </li>
              <li
                className='nav-item'
                onClick={() => {
              ...
              >
                <a className='nav-link cursor-pointer text-active-primary pb-4 active'>
                  Communities
                </a>
              </li>
            </ul>
        ...
        <div id='kt_app_content_container' className='app-container container-xxl'>
              ...
              >
                {/* <div className='mb-10  min-w-200px' style={{display: 'contents'}}>
                      <h5 className='gray-500 mx-10'>
                        Buildings : <span className='fw-semibold'>{count[0]?.totalBuildings}</span>
                      </h5>
                    </div> */}
                <div className='mb-10  min-w-200px' style={{display: 'contents'}}>
          ...
          >
            ...
            {/* <div className='mb-10 min-w-200px'>
                <label className='form-label fw-semibold'>Occupancy Status:</label>
                <div>
                  <select
                    className='form-select form-select-solid'
                    data-kt-select2='true'
                        ...
                        <>
                          <tr>
                            ...
                            <td className='text-center'>
                              {v?.floorId === null ? 'Unit Cluster' : 'Building Cluster'}
                            </td>
