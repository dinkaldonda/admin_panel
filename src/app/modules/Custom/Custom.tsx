...
const Custom = () => {
  ...
  const building = async () => {
    await ApiGet('customization/get-customization')
      .then((res) => {
  ...
  const deleteProperty = (id: any) => {
    ApiDelete(`customization/delete-customization?id=${id}`)
      .then((res: any) => {
                ...
                >
                  <thead>
                    <tr className='text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0'>
                      ...
                      <th className='text-center min-w-100px'>Requirement</th>
                      <th className='text-center min-w-100px'>Quentity</th>
