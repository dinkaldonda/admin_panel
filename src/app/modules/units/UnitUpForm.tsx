          ...
          >
            <ul className='nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-n2'>
              ...
              >
                <a
                  className={`nav-link text-active-primary pb-4 text-center mx-10 ${
                    // formData?.unitType === 'apartment' ? 'active' : 'aaa'
                    formData?.unitType === null? "active" : formData?.unitType === 'apartment' ? 'active' : 'aaa'
                  }`}
                  data-bs-toggle='tab'
                >
                  <div className='mb-2'>
              ...
              >
                <a
                  className={`nav-link text-active-primary pb-4 text-center mx-10 ${
                    formData?.unitType === 'penthouse' ? 'active' : 'aaa'
                  }`}
                  data-bs-toggle='tab'
                >
