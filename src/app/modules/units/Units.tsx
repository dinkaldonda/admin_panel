...
const Units = () => {
  ...
  console.log('111111111111111111111', ClusterId, CommunityId)
  ...
  const getHeaderfData = () => {
    ApiGet(`cooperate/floor/${formData?.propertyAreaId}`)
      .then((res) => {
  ...
  const getHeaderbData = () => {
    ApiGet(`cooperate/building/${formData?.propertyId}`)
      .then((res) => {
        console.log('res', res?.data?.data)
        ...
        <div id='' className='app-container container-xxl flex-stack pt-0 mt-0'>
          ...
          {/* <div className='card-header align-items-center py-5  gap-md-2 text-center pt-15'>
              <div className='mb-5  min-w-200px'>
                <h4 className='fw-bold border text-center p-5'>
                  Building Name: <span className='fw-semibold'>{headerB?.name}</span>
                </h4>
              </div>
              <div className='mb-5  min-w-200px'>
                <h4 className='fw-bold border text-center p-5'>
                  Floor: <span className='fw-semibold'>{header?.name}</span>
                </h4>
              </div>
              <div className='mb-5  min-w-200px'>
                <h4 className='fw-bold border text-center p-5'>
                  Total Properties: <span className='fw-semibold'>{header?.totalProperties}</span>
                </h4>
              </div>
              <div className='mb-5  min-w-200px'>
                <h4 className='fw-bold border text-center p-5'>
                  Total Apartments: <span className='fw-semibold'>{header?.totalApartments}</span>
                </h4>
              </div>
              <div className='mb-5 min-w-200px'>
                <h4 className='fw-bold border text-center p-5'>
                  Total Penthouses: <span className='fw-semibold'>{header?.totalPenthouses}</span>
                </h4>
              </div>
              <div className='mb-5  min-w-200px'>
                <h4 className='fw-bold border text-center p-5'>
              ...
              <ul className='breadcrumb breadcrumb-transparent breadcrumb-line font-weight-bold p-0 my-2 font-size-sm'>
                ...
                <li className='breadcrumb-item '>
                  <a
                    className='text-muted px-2 cursor-pointer'
                    // onClick={() => navigate('/building')}
                    onClick={() => navigate(`/area/${window.location.pathname.split('/')[2]}`)}
                  >
                    {/* {info[0]?.name} */}Floor
                  </a>
                </li>
                  ...
                  <div className='d-flex align-items-center gap-2 gap-lg-3 my-7'>
                    <a
                      ...
                      onClick={() => {
                        ...
                        navigate(
                          `/unitform/${window.location.pathname?.split('/')[2]}/${
                    ...
                    tableData?.map((v: any, i: any) => {
                      return (
                        ...
                        <div className='form-check form-check-sm form-check-custom form-check-solid'>
                          ...
                          <td className='text-center'>{v?.unitType === 'common_area' ? '-' : v?.bedrooms}</td>
                          <td className='text-center'>
                          ...
                          <td className='text-center'>{v?.unitType === 'common_area' ? '-' : v?.premiseNo}</td>
                          <td className='text-center'>
                          {v?.unitType === 'common_area'
                              ? '-'
                              : v?.occupy == '0'
                            ...
                            <Dropdown className='' style={{width: 'fit-content'}}>
                              ...
                              <Dropdown.Menu>
                                <Dropdown.Item
                                  ...
                                  onClick={() =>
                                    navigate(
                                      `/unitUpform/${window.location.pathname?.split('/')[2]}/${
                                        window.location.pathname?.split('/')[3]
                                      }/${v?._id}`
                                    )
                                  }
