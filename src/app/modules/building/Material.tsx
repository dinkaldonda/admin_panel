...
const Material = () => {
  ...
  const building = async () => {
    await ApiGet('material/get-material')
      .then((res) => {
        console.log('res?.data', res?.data)
        setTableData(res?.data?.Material)
      })
  ...
  const handleSubmit = () => {
    if (isEdit) {
      ...
      ApiPut(`material/update-material?id=${updateDataId}`, body)
        .then((res) => {
          SuccessToast(res?.data?.message)
          setFormData({})
      ...
      ApiPost('material/add-material', body)
        .then((res) => {
          SuccessToast(res?.data?.message)
          setFormData({})
          setShowCreateAppModal(false)
