...
const BuildingCluster = () => {
  ...
  const getHeaderfData = async () => {
    await ApiGet(`cooperate/cluster/${window.location.pathname.split('/')[3]}`)
      .then((res) => {
        console.log('res', res?.data?.data)
        setHeader(res?.data?.data)
        ApiGet(`cooperate/communities/${res?.data?.data[0]?.communityId}`)
          .then((res) => {
            console.log('res', res?.data?.data)
  ...
  //   await ApiGet(`cooperate/communities/${id}`)
  //     .then((res) => {
  //       console.log('res', res?.data?.data)
  //       setHeaderB(res?.data?.data)
  //     })
          ...
          {/* <div className='card-header align-items-center py-5  gap-md-2 text-center pt-15'>
              <div className='mb-5  min-w-200px'>
                <h4 className='fw-bold border text-center p-5'>
                  Community Name: <span className='fw-semibold'>abcabc</span>
                </h4>
              </div>
              <div className='mb-5  min-w-200px'>
                <h4 className='fw-bold border text-center p-5'>
                  Cluster Type: <span className='fw-semibold'>Building Cluster</span>
                </h4>
              </div>
              <div className='mb-5  min-w-200px'>
                <h4 className='fw-bold border text-center p-5'>
                  Cluster Name: <span className='fw-semibold'>{header[0]?.name}</span>
                </h4>
              </div>
              <div className='mb-5  min-w-200px'>
                <h4 className='fw-bold border text-center p-5'>
                  Total Building: <span className='fw-semibold'>{header[0]?.totalBuildings}</span>
                </h4>
              </div>
              <div className='mb-5  min-w-200px'>
                <h4 className='fw-bold border text-center p-5'>
                  Total Unit: <span className='fw-semibold'>{header[0]?.totalUnits}</span>
                </h4>
              </div>
            </div> */}
        </div>
