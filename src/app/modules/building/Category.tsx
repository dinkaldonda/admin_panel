...
const Category = () => {
  ...
  const building = async () => {
    await ApiGet('category/get-category')
      .then((res) => {
        ...
        setTableData(res?.data?.category)
      })
      .catch((err) => ErrorToast(err?.message))
  }

  const deleteProperty = (id: any) => {
    ApiDelete(`category/delete-category?id=${id}`)
      .then((res: any) => {
  ...
  const handleSubmit = () => {
    if (isEdit) {
      ...
      ApiPut(`category/update-category?id=${updateDataId}`, body)
        .then((res) => {
          SuccessToast(res?.data?.message)
          setFormData({})
      ...
      ApiPost('category/add-category', body)
        .then((res) => {
          SuccessToast(res?.data?.message)
          setFormData({})
          setShowCreateAppModal(false)
