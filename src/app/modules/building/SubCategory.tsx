...
const SubCategory = () => {
  ...
  const building = async () => {
    await ApiGet('subcategory/get-subcategory')
      .then((res) => {
        ...
        setTableData(res?.data?.subcategory)
      })
  ...
  const handleSubmit = () => {
    if (isEdit) {
      ...
      const body = {
        categoryId: formData?.categoryName ?? '64189ddf75ac0242b4513929',
        name: formData?.name,
      }
                ...
                >
                  <thead>
                    <tr className='text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0'>
                      ...
                      <th className='text-center min-w-100px'>Furniture Item</th>
                      <th className='text-center min-w-100px'></th>
