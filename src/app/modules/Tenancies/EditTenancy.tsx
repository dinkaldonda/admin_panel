...
import { ApiDelete, ApiGet, ApiGetNoAuth, ApiPost, ApiPut, ApiUpload } from '../../../apiCommon/helpers/API/ApiData'
...
const EditTenancy = () => {
  ...
  const getTenancyData = async () => {
    await ApiGet(`cooperate/tenancy/${window.location.pathname.split('/')[2]}`)
      .then((res) => {
        ...
        setBenefit(res?.data?.data[0]?.benefits)
      })
      .catch((e) => {
        console.log(e)
      })
  ...
  const handleEdit = async () => {
    const body = {
      ...
      benefits: {
        none: benefit.none,
        chillerFree: benefit.chillerFree,
        maintenanceFree: benefit.maintenanceFree,
        other: ["freeparking"]
      }
    }
    await ApiPut(`cooperate/tenancy`, body)
      .then((res) => {
       SuccessToast(res?.data?.message)
      })
      .catch((e) => {
            ...
            <Row>
              <Col md={2}>
                <div className='d-flex'>
                  ...
                  <div className='m-5'>
                    <img
                      src='https://wallpaperaccess.com/full/1137443.jpg'
                      alt=''
                      width={170}
                      height={150}
                    />
                      ...
                      />
                          ...
                          <div className='mb-10 min-w-200px mx-10'>
                            ...
                            <input
                              ...
                              placeholder=''
                              name='contractNo'
                              value={tenancy?.contractNo}
                              onChange={(e) => setTenancy({ ...tenancy, [e.target.name]: e.target.value })}
                            />
                          </div>
                          <div className='mb-10 min-w-200px mx-10'>
                            <label htmlFor='exampleFormControlInput1' className='required form-label'>
                            ...
                            <select
                              ...
                              value={tenancy?.tenancyStatus === 0 ? 'Booked'
                                :
                                tenancy?.tenancyStatus === 1 ? 'Active'
                                  : tenancy?.tenancyStatus === 2 ? 'Renewed'
                                    : ''
                              }
                              onChange={(e) => setTenancy({ ...tenancy, [e.target.name]: e.target.value })}
                            >
                          ...
                          <div className='d-flex'>
                            <div className='form-check form-check-custom form-check-solid form-check-sm'>
                              <input
                                ...
                                name='none'
                                // defaultChecked
                                checked={benefit?.none}
                                onChange={(e) => setBenefit({ ...benefit, [e.target.name]: !benefit?.none })}
                                onClick={() => {
                                  setOption(1)
                                }}
                              />
                            ...
                            <div className='form-check form-check-custom form-check-solid form-check-sm ms-3'>
                              <input
                                ...
                                id='occupied'
                                name='chillerFree'
                                checked={benefit.chillerFree}
                                onChange={(e) => setBenefit({ ...benefit, [e.target.name]: !benefit.chillerFree })}
                              />
                            ...
                            <div className='form-check form-check-custom form-check-solid form-check-sm ms-3'>
                              <input
                                ...
                                checked={benefit.maintenanceFree}
                                onChange={(e) => setBenefit({ ...benefit, [e.target.name]: !benefit.maintenanceFree })}
                                onClick={() => {
                                  setOption(3)
                                }}
                              />
                            ...
                            <div className='form-check form-check-custom form-check-solid form-check-sm ms-3'>
                              <input
                                ...
                                id='occupied'
                                name='other'
                                checked={benefit.other}
                                onChange={(e) => setBenefit({ ...benefit, [e.target.name]: !benefit.other })}
                                onClick={() => {
                                  setOption(4)
                                }}
                              />
                              ...
                              {option === 4 && (
                                <input
                                  ...
                                  name='other'
                                  value={benefit.other}
                                  onChange={(e) => setBenefit({ ...benefit, [e.target.name]: e.target.value })}
                                />
                              )}
                            </div>
                          </div>
