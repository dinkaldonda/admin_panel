...
const Step1 = ({data, updateData, hasError}: any) => {
  return (
      ...
      <div className='w-100'>
        ...
        <div className='fv-row'>
          ...
          <label className='d-flex align-items-center fs-5 fw-semibold mb-4'>
            <span className='required'>Portfolio Type</span>

            <i
              className='fas fa-exclamation-circle ms-2 fs-7'
              data-bs-toggle='tooltip'
              title='Select your Portfolio Type'
            ></i>
          </label>
          {/* end::Label */}
          <div>
            ...
            <label className='d-flex align-items-center justify-content-between mb-6 cursor-pointer'>
              <span className='d-flex align-items-center me-2'>
                ...
                <span className='d-flex flex-column'>
                  <span className='fw-bolder fs-6'>Residential</span>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input
                  ...
                  name='portfolioType'
                  value='residential'
                  checked={data.portfolioType === 'residential'}
            ...
            <label className='d-flex align-items-center justify-content-between mb-6 cursor-pointer'>
              <span className='d-flex align-items-center me-2'>
                ...
                <span className='d-flex flex-column'>
                  <span className='fw-bolder fs-6'>Commercial</span>
                  {/* <span className='fs-7 text-muted'>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input
                  ...
                  name='portfolioType'
                  value='commercial'
                  checked={data.portfolioType === 'commercial'}
                  onChange={(e) => updateData(e)}
                />
              </span>
            </label>
